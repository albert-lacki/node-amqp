...
Exchange.prototype._onMethod = function (channel, method, args) {
  ...
  switch (method) {
    ...
    case methods.basicAck:
      ...
      var sequenceNumber = args.deliveryTag, tag;
      ...
      if (sequenceNumber === 0 && args.multiple === true) {
        ...
        // if we are here it means that something terribly wrong happened and we are left with unhandled callbacks
        throw new Error('Unhandled confirm callback for sequence number: ' + sequenceNumber);
      }
      break;
